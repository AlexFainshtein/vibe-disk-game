...
export const FLOOR_BOUNCE           = 1.1;    // restitution for bottom edge (> 1 adds energy)
...
export const MALLET_INNER_RESTITUTION = 0.1;  // restitution against inner wall (< 1 = energy loss)
